...
f0 = 0            # scaling factor for n=0 flux
...
imnp.source = source
imnp.save_fits('./m87_model_%s_np.fits'%label)
...
if polarization:
    ...
    imsth.source = source
    #imn.save_fits('./m87_model_%s_sinthb.fits'%label)
    ...
    img.source = source
    #imn.save_fits('./m87_model_%s_g3.fits'%label)
